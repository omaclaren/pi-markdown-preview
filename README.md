...
- **Local document links in watch mode** — click linked Markdown, LaTeX or common text/code files to open rendered snapshots in another tab, with relative images and nested links resolved from each file
